...
sampleFLC <- function(BtY, Beta, Psi, BtB, Omega, lambda, sigmat2) {
    .Call(`_fosr_sampleFLC`, BtY, Beta, Psi, BtB, Omega, lambda, sigmat2)
}
...
sampleFLC_orthog <- function(BtY, Beta, Psi, Omega, lambda, sigmat2) {
    .Call(`_fosr_sampleFLC_orthog`, BtY, Beta, Psi, Omega, lambda, sigmat2)
}
...
sampleFLC_cons <- function(BtY, Beta, Psi, BtB, Omega, BtCon, lambda, sigmat2) {
    .Call(`_fosr_sampleFLC_cons`, BtY, Beta, Psi, BtB, Omega, BtCon, lambda, sigmat2)
}
...
sampleFLC_cons_1 <- function(BtY, Beta, Psi, BtB, Omega, BtCon, lambda, sigmat2) {
    .Call(`_fosr_sampleFLC_cons_1`, BtY, Beta, Psi, BtB, Omega, BtCon, lambda, sigmat2)
}
...
sampleFLC_1 <- function(BtY, Beta, Psi, BtB, Omega, lambda, sigmat2) {
    .Call(`_fosr_sampleFLC_1`, BtY, Beta, Psi, BtB, Omega, lambda, sigmat2)
}
